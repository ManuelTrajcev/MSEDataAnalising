...
from utils import get_10_year_data, get_missing_data,get_last_date_string
...
def filter_3(companies_last_dates):
    ...
    with Manager() as manager:
        ...
        chunk_size = (len(companies_last_dates) + num_cores - 1) // num_cores

        company_chunks = [companies_last_dates[i:i + chunk_size] for i in
                          range(0, len(companies_last_dates), chunk_size)]
