...
def process_company_data2(company_code, indicators=['SMA(50)', 'SMA(200)', 'EMA(50)', 'EMA(200)', 'Ichimoku_Baseline'],
                          freqs=['1D', '1W', '1ME']):
    """
    ...
    for indicator in indicators:
        if 'SMA' in indicator:
            ...
            if len(data) >= window:
                ...
                data[indicator] = data['last_transaction_price'].rolling(window=small_window).mean()
...
if __name__ == '__main__':
    company_code = 'ALK'
    indicators = ['SMA(50)', 'SMA(100)', 'EMA(50)', 'EMA(100)', 'Ichimoku_Baseline']
    freqs = ['1D', '1W', '1ME']

    try:
        processed_data = process_company_data2(company_code, indicators, freqs)
        pd.set_option('display.max_columns', None)
        print(len(processed_data['1ME']))
        print(processed_data['1ME'].tail(1))  # Example: Last row of daily data
