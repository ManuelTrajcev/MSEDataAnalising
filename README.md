...
### Корекција на филтер 1 поради недостапност на податцои на mse.mk
  Додадена е фунцкија filter_1_correct која ги зема шифрите за сите компании од друг извор. Во pipieline.py има две линии за повикување на process_data, од кои едната е искометирана. Првата (искоментирата) го користи првичинот начин за земање на податоците, а втората е со новиот.
